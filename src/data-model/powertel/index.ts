...
export type ModelRange = airtime.Super | airtimeSale.Super | card.Super | cardSale.Super | newAirtimeStock.Super | newCardStock.Super 
export type ModelArrayRange = airtime.Super[] | airtimeSale.Super[] | card.Super[] | cardSale.Super[] | newAirtimeStock.Super[] | newCardStock.Super[]